...
3. It should give them a chance to go into depth. In order to be about the basics without being a quiz, it should allow the person to dive as deep as they are able. This gives them a chance to show off what they know
...
Problem solving in a vacuum. No ML needed, but may bias towards Comp Sci majors since it is algorithmic.
